export default function TermsContent({ headingClassName = "text-sm font-semibold" }: { headingClassName?: string }) {
  return (
    <div className="space-y-5">
      <section className="space-y-2">
        <h2 className={headingClassName}>1. Acceptance of Terms</h2>
      ...
      <section className="space-y-2">
        <h2 className={headingClassName}>2. Consent to Be Contacted</h2>
        <p className="text-sm text-zinc-400">
      ...
      <section className="space-y-2">
        <h2 className={headingClassName}>3. Accounts</h2>
        <p className="text-sm text-zinc-400">
      ...
      <section className="space-y-2">
        <h2 className={headingClassName}>4. User Content</h2>
        <p className="text-sm text-zinc-400">
      ...
      <section className="space-y-2">
        <h2 className={headingClassName}>5. Privacy</h2>
        <p className="text-sm text-zinc-400">
      ...
      <section className="space-y-2">
        <h2 className={headingClassName}>6. Changes</h2>
        <p className="text-sm text-zinc-400">
      ...
      <section className="space-y-2">
        <h2 className={headingClassName}>7. Contact</h2>
        <p className="text-sm text-zinc-400">
